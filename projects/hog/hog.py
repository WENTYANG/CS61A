...
def free_bacon(score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    outcome , ones , tens = 2 , 0 , 0
    if score // 10 == 0:
        outcome = outcome + score
    else:
        ones = score % 10
        tens = (score // 10) % 10
        outcome = outcome + abs(ones - tens)
    return outcome
    # END PROBLEM 2
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if player == 0:
            ...
            #print('player0 rolls:num_rolls=',num_rolls,',score0=',score0,',score1=',score1)
        else:
            num_rolls = strategy1(score1,score0)
            score1 = score1 + take_turn(num_rolls,score0,dice)
            #print('player1 rolls:num_rolls=',num_rolls,',score0=',score0,',score1=',score1)
...
def announce_lead_changes(previous_leader=None):
    ...
    >>> f3 = f2(8, 12) #leader一直为1，print语句不会被执行
    >>> f4 = f3(8, 13)
    >>> f5 = f4(15, 13)
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    while num_rolls <= 10:
        ...
        scores.append(averaged(num_rolls,dice))
        num_rolls = num_rolls + 1
    max_rolls = scores.index(max(scores)) + 1
    return max_rolls
    # END PROBLEM 9
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 11
    free_score = score + free_bacon(opponent_score)
    if free_bacon(opponent_score) >= margin:
        return 0
    elif is_swap(free_score,opponent_score) and free_score < opponent_score:
        return 0
    else:
        return num_rolls  # Replace this statement
    # END PROBLEM 11
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    margin = make_averaged(roll_dice)(num_rolls,dice)
    return swap_strategy(margin,num_rolls)
    # END PROBLEM 12
